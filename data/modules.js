...
<p>The AI didn't replace the human. It collapsed the time in the gap from 15 minutes to 2 minutes.</p>`,
      },
      {
        ...
        title:'[SMB] AI Readiness for Growing Businesses',
        content:`<h2>SMB AI Readiness</h2>
...
<h3>The SMB Readiness Checklist</h3>
...
<li>❌ Safety-critical without human oversight</li>
      ...
      },
      {
        ...
        title:'[SMB] Use Case Playbooks by Function',
        content:`<h2>SMB Use Case Playbooks</h2>
...
<p><strong>AI Decides → Human Monitors:</strong> Autonomous routing within guardrails. Human reviews aggregate outcomes.</p>`,
      },
      {
        ...
        title:'[SMB] Workflow Design for Small Teams',
        content:`<h2>Workflow Design in Small Teams</h2>
<h3>The SMB Design Process</h3>
...
<blockquote><p>Start with Azure OpenAI or AWS Bedrock for data privacy. Use Power Automate for workflow integration to stay within your existing governance perimeter.</p></blockquote>`,
      },
      {
        ...
        title:'[SMB] SMB Tool Stack Recommendations',
        content:`<h2>Recommended SMB AI Stack</h2>
<h3>Tier 1: Start Here (Month 1–3)</h3>
<p><strong>Claude or GPT-4o via API:</strong> Summarisation, drafting, classification. AUD ~$50–200/month at typical SMB volumes.</p>
...
<p><strong>Time savings:</strong> Weekly reporting: 4–8 analyst hours → 15–30 minutes review. Saving: 85–95% of effort.</p>`,
      },
      {
        ...
        title:'[SMB] From Prompt to Production in 4 Weeks',
        content:`<h2>SMB Implementation Playbook</h2>
...
<p><strong>W12:</strong> Month 1 ROI · Stakeholder report · Plan use case 2</p>`,
      },
      {
        ...
        title:'[SMB] SMB Execution: Doing More with Less',
        content:`<h2>SMB 90-Day Execution</h2>
<h3>The SMB Execution Principles</h3>
...
<p style="margin-top:24px;font-size:1rem;font-weight:600;color:white">Congratulations on completing the Flowcore AI Academy. Your execution starts now. 🎉</p>`,
      },
    ],
  },
]
