...
export const TEMPLATES = [
  ...
  { id:'smb-implementation',    name:'Business Implementation Guide',       format:'PDF',  tier:'smb',        moduleId:'module-5', icon:'⚙️', desc:'End-to-end AI deployment guide for growing businesses.' },
