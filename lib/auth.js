      ...
      if (!profile) {
        ...
        if (!profile) {
          ...
          const newProfile = {
            ...
            // Launch offer: every new account starts with Journey for 30 days.
            // Parents & Caregivers remains the complimentary fallback track.
            user_type: 'journey',
            selected_tier: 'journey',
          ...
          setUser({
            ...
            tier: 'journey',
            journeyExpiresAt: newProfile.journey_expires_at,
            progress: {},
            scores: {},
          })
