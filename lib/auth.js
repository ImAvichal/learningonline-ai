      ...
      if (!profile) {
        ...
        if (!profile) {
          ...
          const newProfile = {
            ...
            // free 'parents' base; paid enrolment (Journey trial / Pro) upgrades
            // this via the Stripe webhook. Keeps the Journey paid funnel intact
            // (a 'parents' user is NOT treated as already having Journey).
            user_type: 'parents',
