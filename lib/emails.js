...
<body style="margin:0;padding:0;background:#f7f8fa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#0a1628;">
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width:600px;margin:0 auto;background:#ffffff;">
    <!-- Header -->
    <tr>
      <td style="padding:40px 40px 20px;text-align:left;border-bottom:1px solid #e8eaf0;">
    ...
    <tr>
      <td style="padding:36px 40px 8px;">
        <h1 style="margin:0 0 16px;font-size:26px;font-weight:800;line-height:1.25;color:#0a1628;">
          You're in, ${firstName}.
        </h1>
    ...
    <tr>
      <td style="padding:8px 40px 36px;text-align:center;">
        <a href="https://www.learningonline.ai/dashboard"
           style="display:inline-block;padding:16px 40px;background:#1a6eff;color:#ffffff;text-decoration:none;font-weight:700;font-size:16px;border-radius:10px;">
          Start Learning →
        </a>
      </td>
    </tr>
