...
const campaign = fs.readFileSync('pages/api/admin/send-journey-campaign.js', 'utf8')
const checks = [
  ...
  ['Campaign limited to expiring Journey trials', campaign.includes(".not('journey_expires_at', 'is', null)")],
