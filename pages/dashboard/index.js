  ...
  return (
    <div className="p-8 lg:p-10 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-muted">{totalPct === 0 ? "Let's get you started — one focused lesson at a time." : totalPct === 100 ? "You've completed the pathway. Revisit anything any time." : "You're making real progress. Pick up where you left off."}</p>
      </div>
      ...
      {nextLesson && (
        <div className="bg-blue/5 border border-blue/30 rounded-xl p-5 mb-8 flex items-center justify-between gap-4">
          <div className="min-w-0 flex-1">
            ...
            <div className="font-display font-bold text-base text-white mb-0.5 truncate">{nextLesson.title}</div>
            <div className="text-sm text-muted truncate">Module {nextLesson.moduleNumber}: {nextLesson.moduleTitle}</div>
          </div>
