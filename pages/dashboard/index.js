...
function Dashboard() {
  ...
  const templates     = getTemplatesForTier(user.tier)

  return (
    <>
      <Head><title>Dashboard — Flowcore AI Academy</title></Head>
      ...
      {user.tier === 'smb' && (
        <div className="mb-8 p-6 rounded-xl bg-amber-400/5 border border-amber-400/20">
          <div className="flex items-start gap-4">
            <span className="text-2xl">💼</span>
            <div>
              <div className="text-xs font-display font-bold text-amber-400 uppercase tracking-wider mb-1">SMB Access</div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="font-display font-bold text-base mb-1">
                {user.tier === 'individual' ? 'Upgrade to SMB for team access' : 'Upgrade to Enterprise for the full transformation program'}
              </h3>
