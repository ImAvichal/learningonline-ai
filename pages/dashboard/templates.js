    ...
    return (
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-xs text-gray-500 ml-auto">{items.length} template{items.length !== 1 ? 's' : ''}</span>
        </div>
              ...
              <Card light key={tpl.id} hover className="p-5 flex flex-col">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-display font-bold px-2 py-0.5 bg-white border border-gray-200 rounded-full text-gray-500">
                      {tpl.format}
                    </span>
                  </div>
                </div>
    ...
    <div className="p-8 lg:p-10">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm">
          {resources.length} templates included with your <strong className="text-gray-900 capitalize">{tier}</strong> tier.
      ...
      {/* Locked preview */}
      {tier !== 'enterprise' && (
        <div className="mt-4 p-8 border border-dashed border-gray-200 rounded-xl text-center">
      ...
      {/* How to use */}
      <Card light className="p-6 mt-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={s.n} className="flex gap-4">
              ...
              <div>
                <div className="font-display font-bold text-sm text-gray-900 mb-1">{s.t}</div>
