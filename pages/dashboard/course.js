...
export default function CoursePage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <aside className={`
        fixed lg:sticky top-0 bottom-0 left-0 z-40 w-72 bg-gray-50 border-r border-gray-200
            ...
            return (
              <div key={mod.id}>
                <button onClick={() => setExpanded(p => ({ ...p, [mi]: !p[mi] }))}
                  className={`w-full flex items-center gap-3 px-4 py-3 border-b border-gray-100 transition-colors ${isActiveMod ? 'bg-blue/[0.06]' : 'hover:bg-white'}`}>
