            ...
            <div className="flex gap-12 flex-wrap">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <Link href="#learning-tracks" className="block text-sm text-muted hover:text-white">Find My Tier</Link>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/terms"     className="block text-sm text-muted hover:text-white">Terms &amp; Refund Policy</Link>
                </div>
              </div>
              <div>
