...
export default function ROICalculator() {
  ...
  return (
    <>
      <Head>
        <title>ROI Calculator — LeO AI</title>
      ...
      <div className="pt-24 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <SectionLabel>One way to measure value</SectionLabel>
            <h1 className="font-display font-black text-3xl sm:text-5xl tracking-tight mb-4 break-words">Calculate Your AI ROI</h1>
            <p className="text-muted text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
              Model your investment before you commit — break-even timeline, 5-year projection,
              and sensitivity analysis. A useful sense-check, not a verdict.
            </p>
            <p className="text-sm text-gray-500 mt-4">
              <Link href="/mindset" className="text-blue hover:underline">← Back to Mindset</Link>
              <span className="mx-2">·</span>
              <span>ROI captures cost-side gains. Many of AI&apos;s biggest wins live elsewhere.</span>
            </p>
          </div>
